...
struct SplitDenoiseStageTimers {
...
class SplitDenoiseRunner {
 public:
  ...
  SplitDenoiseRunner& operator=(SplitDenoiseRunner&&) = delete;
  SplitDenoiseRunner(const SplitDenoiseRunner&) = delete;
  SplitDenoiseRunner& operator=(const SplitDenoiseRunner&) = delete;

  Status Load();
  Status RunOnce(const SplitDenoiseRequest& request, SplitDenoiseResult* result);
 ...
 private:
  ...
  SplitDenoiseStageTimers timers_;
